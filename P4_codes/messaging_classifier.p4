...
header classification_result_t {
    ...
    timestamp_t mes_ts_1;
    timestamp_t mes_ts_2;
    timestamp_t flow_duration;
}
...
{   
    ...
    Register<bit<16>, bit<16>>(1) reg_flowid_from_header;
    ...
    apply {
        if(hdr.extracted_features.isValid()) {
            ...
            reg_flowid_from_header.write((bit<16>)0, hdr.extracted_features.flow_id);
            ...
            hdr.classification_result.mes_ts_1 = meta.ts_1; 
            hdr.classification_result.mes_ts_2 = meta.ts_2; 
            ...
            hdr.classification_result.srcPort = hdr.tcp.srcPort;
